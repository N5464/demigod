...
import { getUniqueNiches, getUniqueStatuses } from '../services/googleSheets';
...
const LeadTable: React.FC = () => {
  ...
  return (
    <div className="card h-full flex flex-col overflow-hidden">
      ...
      <div className="p-4 bg-white border-b border-gray-200 grid grid-cols-1 md:grid-cols-2 gap-3">
